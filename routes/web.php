    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::middleware(['permission:'.PortalPermissions::INDUCTION_POLICY_MANAGE])
            ...
            ->group(function () {
                ...
                Route::post('/policies/{policy}/versions', [InductionPolicyAdminController::class, 'storeVersion'])->name('policies.versions.store');
                Route::get('/versions/{version}', [InductionPolicyAdminController::class, 'showVersion'])->name('versions.show');

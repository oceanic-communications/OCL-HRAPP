...
<div class="space-y-3 text-sm text-foreground">
    <label class="flex cursor-pointer gap-2">
        ...
        <span><span class="font-semibold">Yes</span> — staff must complete this published induction again: progress for this version is reset and every active account receives a dashboard notification.</span>
    </label>
    <label class="flex cursor-pointer gap-2">
